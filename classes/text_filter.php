...
if (class_exists('\core_filters\text_filter')) {
    class_alias('\core_filters\text_filter', 'vdo_base_filter');
} else {
    class_alias('\moodle_text_filter', 'vdo_base_filter');
}

/**
 * Main filter class
 */
class text_filter extends \vdo_base_filter
{
    private static $csk;
